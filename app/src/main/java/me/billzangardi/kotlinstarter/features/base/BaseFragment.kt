package me.billzangardi.kotlinstarter.features.base
...
import me.billzangardi.kotlinstarter.KotlinStarterApplication
import me.billzangardi.kotlinstarter.injection.component.ConfigPersistentComponent
import me.billzangardi.kotlinstarter.injection.component.DaggerConfigPersistentComponent
import me.billzangardi.kotlinstarter.injection.component.FragmentComponent
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (sComponentsArray.get(mFragmentId) == null) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .applicationComponent(KotlinStarterApplication[activity].component)
                    .build()
